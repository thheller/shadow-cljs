 ...
 * https://github.com/google/closure-compiler/blob/81af4552e688f341e46011a28ab08973a23737fb/src/com/google/javascript/jscomp/RescopeGlobalSymbols.java
 *
 * Trying to work out the minimal set of changes to make this useable in a node context.
 *
 * not at all easy to make use of this though since everything is final or otherwise inaccessible
 */
final class RescopeGlobalSymbolsFork implements CompilerPass {

    // Appended to variables names that conflict with globalSymbolNamespace.
    private static final String DISAMBIGUATION_SUFFIX = "$";
    private static final String WINDOW = "global";
