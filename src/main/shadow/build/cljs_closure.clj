...
;; this is the cljs/closure.clj from the cljs 1.9.946 release
;; https://raw.githubusercontent.com/clojure/clojurescript/85b882b728984734793d635c923bfab0f71ba00f/src/main/clojure/cljs/closure.clj
;; I want to use newer versions of closure buy can't since cljs.closure has one tiny reference to
;; a class that was removed. until there is a new cljs release this hack is required
;; the only is change is the removal of COMMON_JS_LOAD reference
;;
;; shadow-cljs actually uses nothing from cljs.closure but cljs.repl requires it so we must be able to load it
